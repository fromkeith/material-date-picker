          ...
          getWeeks = function(monthLength, startDay, month) {
            ...
            weeks = monthDays.map(function(e, i) {
              if (i % chunk_size === 0) {
                return {
                  id: 'id_' + i + '_' + month,
                  week: monthDays.slice(i, i + chunk_size)
                };
              } else {
                return null;
              }
